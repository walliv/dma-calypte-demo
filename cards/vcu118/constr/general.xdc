...
#set_property PACKAGE_PIN AY30 [get_ports {}]
#set_property PACKAGE_PIN BB32 [get_ports {}]
...
set_property IOSTANDARD LVCMOS12    [get_ports -filter NAME=~STATUS_LEDS*]
set_property DRIVE 8                [get_ports -filter NAME=~STATUS_LEDS*]
set_false_path -to                  [get_ports -filter NAME=~STATUS_LEDS*]
